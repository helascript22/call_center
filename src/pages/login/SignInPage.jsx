      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-black border-none">
          <CardHeader className="text-center space-y-1 pb-2">
            ...
            <CardTitle className="text-2xl font-bold text-white">Sign In to getting started</CardTitle>
          ...
          <CardContent className="space-y-6">
            <form className="space-y-6">
              ...
              <div className="flex justify-between items-center text-sm text-gray-400">
                ...
                <Link to="/recover-password"><a href="#" className="text-blue-500 hover:underline">Recover Password</a></Link>
              </div>
